...
public partial class Monitor
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Debug, Message = "Registered IO {VariableName} with update interval: {UpdateInterval}")]
    private partial void LogVariableRegistered(string variableName, int updateInterval);
