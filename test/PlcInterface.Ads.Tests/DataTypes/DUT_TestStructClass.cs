...
namespace PlcInterface.Ads.Tests.DataTypes
{
    ...
    internal class DUT_TestStructClass
    {
        public static DUT_TestStructClass Default => new DUT_TestStructClass()
        {
            ...
            TimeValue = new TIME(0, 0, 0, 1, 0),
            TimeOfDay = new TOD(0, 1, 0, 0, 0),
            LTimeValue = new LTIME(0, 0, 0, 1000),
            DateValue = new DATE(2106, 02, 05),
            DateAndTimeValue = new DT(2106, 02, 05, 06, 28, 15),
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<TIME>.Default.GetHashCode(TimeValue);
            hashCode = hashCode * -1521134295 + EqualityComparer<TOD>.Default.GetHashCode(TimeOfDay);
            hashCode = hashCode * -1521134295 + EqualityComparer<LTIME>.Default.GetHashCode(LTimeValue);
            hashCode = hashCode * -1521134295 + EqualityComparer<DATE>.Default.GetHashCode(DateValue);
